...
#define  FILL_ITEMDATA(index, fieldName, IsNew)\
if(IsNew){\
		arrpsz[index] = new TCHAR[ lstrlen( fieldName ) + 1 ];\
		(void)lstrcpy( arrpsz[ index ], fieldName );\
}\
clrText[ index ] = crWindowText;\
clrBak[ index] = crWindow;\
//////////////////////////////////////////////////////////////////////////

#define  IDM_UPLOAD 13000
...
{
	//DECLARE_DYNAMIC(CGridListCtrlEx)///新加
public:
	CGridListCtrlEx();
	~CGridListCtrlEx();
...
private:
	...
	//////////////////////////////////////////////////////////////////////////按钮测试区//新加
private:
	typedef map<int, CMButton*> BUTTON_MAP;
	//创建Button映射表
...
public:
	...
	typedef vector<ItemData*> MEMORY_MANAGER_VECTOR;
	MEMORY_MANAGER_VECTOR m_memoryManager;
	void ReleaseMemory();
